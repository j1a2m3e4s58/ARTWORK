...
export default function Messages() {
  ...
  useEffect(() => {
    ...
    const syncViewportHeight = () => {
      ...
      document.documentElement.style.setProperty('--messages-viewport-top', `${Math.max(0, Math.round(top))}px`);
    };
    syncViewportHeight();
